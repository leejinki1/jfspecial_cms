 ...
 * 
 */
package com.jfspecial.jfinal.component.annotation;
...
import com.jfspecial.util.annotation.ClassSearcher;
...
public class AutoBindModels {
	...
	public void config() {
		...
		for (Class model : controllerClasses) {
			...
			ModelBind = (com.jfspecial.jfinal.component.annotation.ModelBind) model.getAnnotation(com.jfspecial.jfinal.component.annotation.ModelBind.class);
