...
public class TbVideoTags extends BaseProjectModel<TbVideoTags> {
    ...
    public TbVideoTags setId(Integer value) {
        set(ID, value);
        return this;
    }
    ...
    public TbVideoTags setVideoId(Integer value) {
        set(VIDEO_ID, value);
        return this;
    }
    ...
    public TbVideoTags setTagname(String value) {
        set(TAGNAME, value);
        return this;
    }
    ...
    public TbVideoTags setCreateTime(String value) {
    ...
    public TbVideoTags setCreateId(Integer value) {
        set(CREATE_ID, value);
        return this;
    }
