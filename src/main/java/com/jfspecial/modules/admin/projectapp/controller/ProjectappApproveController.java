...
public class ProjectappApproveController extends BaseProjectController {
	...
	private static final String path = "/pages/admin/projectapp/projectapp_approve";

	//显示待审核
	public void index() {
		String sql = "select t.id,t.name,t.publish_user, t.update_time from tb_projectapp t where  status = 1 and approve_status = 1  and is_draft=0 order by sort,id desc";
        //待审核:审核状态=1初始+++不在草稿箱
