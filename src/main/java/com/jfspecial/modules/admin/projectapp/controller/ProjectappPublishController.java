 ...
 * zr  2018.11.27
 */
@ControllerBind(controllerKey = "/admin/projectapp_publish")
public class ProjectappPublishController extends BaseProjectController {

	private static final String path = "/pages/admin/projectapp/projectapp_publish";
