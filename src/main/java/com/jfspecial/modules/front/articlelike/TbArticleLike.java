...
public class TbArticleLike extends BaseProjectModel<TbArticleLike> {
	...
	public TbArticleLike setId(Integer value) {
		set(ID, value);
		return this;
	}
	...
	public TbArticleLike setArticleId(Integer value) {
	...
	public TbArticleLike setCreateTime(String value) {
	...
	public TbArticleLike setCreateId(Integer value) {
		set(CREATE_ID, value);
		return this;
	}
