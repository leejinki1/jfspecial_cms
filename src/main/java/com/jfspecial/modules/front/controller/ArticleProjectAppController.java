 ...
 */
@ControllerBind(controllerKey = "/front/projectapp/article")
public class ArticleProjectAppController extends BaseProjectController {
	...
	public void index() {
		...
		TbProjectApp article = TbProjectApp.dao.findById(articleId);
