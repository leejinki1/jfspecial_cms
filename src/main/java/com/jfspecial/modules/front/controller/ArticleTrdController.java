 ...
 */
@ControllerBind(controllerKey = "/front/trd/article")
public class ArticleTrdController extends BaseProjectController {
	...
	public void index() {
		...
		TbTrd article = TbTrd.dao.findById(articleId);
		...
		renderAuto(path + "trd_article.html");
