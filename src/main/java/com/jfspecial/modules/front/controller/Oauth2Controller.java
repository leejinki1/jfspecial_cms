...
import com.jfspecial.jfinal.component.oauth.OauthBaidu;
import com.jfspecial.jfinal.component.oauth.OauthQQ;
import com.jfspecial.jfinal.component.oauth.OauthSina;
import com.jfspecial.jfinal.component.oauth.util.TokenUtil;
import com.jfspecial.modules.CommonController;
import com.jfspecial.modules.admin.article.TbArticle;
import com.jfspecial.modules.admin.site.TbSite;
import com.jfspecial.modules.front.interceptor.FrontInterceptor;
import com.jfspecial.modules.front.service.Oauth2Service;
...
public class Oauth2Controller extends BaseProjectController {
	...
	protected void toMainPage(JSONObject json, String username, String openid) {
		...
		if (user == null) {
			...
			user.set("password", JFSpecialUtils.getDefaultPassword());
			user.set("usertype", JFSpecialUtils.USER_TYPE_THIRD); // 第三方用户
			user.set("departid", JFSpecialUtils.DEPART_THIRD_ID);
			user.set("state", 1);
