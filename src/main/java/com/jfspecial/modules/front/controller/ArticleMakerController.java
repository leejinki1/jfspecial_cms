 ...
 */
@ControllerBind(controllerKey = "/front/maker/article")
public class ArticleMakerController extends BaseProjectController {
	...
	public void index() {
		...
		TbMaker article = TbMaker.dao.findById(articleId);
		...
		renderAuto(path + "maker_article.html");
