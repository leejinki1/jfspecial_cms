 ...
 */
@ControllerBind(controllerKey = "/front/addoil/article")
public class ArticleAddOilController extends BaseProjectController {
	...
	public void index() {
		...
		TbAddOil article = TbAddOil.dao.findById(articleId);
		...
		renderAuto(path + "addoil_article.html");
