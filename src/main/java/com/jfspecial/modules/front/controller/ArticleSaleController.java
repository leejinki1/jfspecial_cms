 ...
 */
@ControllerBind(controllerKey = "/front/sale/article")
public class ArticleSaleController extends BaseProjectController {
	...
	public void index() {
		...
		TbSale article = TbSale.dao.findById(articleId);
