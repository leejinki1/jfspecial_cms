...
$(document).on("click",".centerBox-right-c2 td a",function(){
	...
	$(".centerBox-right-c2").load("static/frontend/html/trd/jishuxuqiu_right_2_child.html");
	$(".centerBox-left-c2").load("static/frontend/html/trd/jishuxuqiu_left_2_2.html");
